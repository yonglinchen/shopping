...
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES ('1', 'ECS000000', '福佳（Hoegaarden） 白啤酒330ml 瓶装', '8', '10', '0.110', '1665.60', '1388.00', '', '<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 很多朋友都已经抢先体验了3G网络的可视通话、高速上网等功能。LG KD876手机<span style=\"font-size: x-large;\"><span style=\"color: rgb(255, 0, 0);\"><strong>支持TD-SCDMA/GSM双模单待</strong></span></span>，便于测试初期GSM网络和TD网络之间的切换和共享。</p>\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; LG KD876手机整体采用银色塑料材质，<strong><span style=\"font-size: x-large;\"><span style=\"color: rgb(255, 0, 0);\">特殊的旋转屏设计是本机的亮点</span></span></strong>，而机身背部的300万像素摄像头也是首发的六款TD-SCDMA手机中配置最高的。LG KD876手机屏幕下方设置有外键盘，该键盘由左/右软键、通话/挂机键、返回键、五维摇杆组成，摇杆灵敏度很高，定位准确。KD876的内键盘由标准12个电话键和三个功能键、一个内置摄像头组成。三个功能键分别为视频通话、MP3、和菜单键，所有按键的手感都比较一般，键程适中，当由于按键排列过于紧密，快速发短信时很容易误按，用户在使用时一定要多加注意。LG KD876手机机身周边的接口设计非常简洁，手机的厚度主要来自屏幕旋转轴的长度，如果舍弃旋屏设计的话，估计<span style=\"font-size: x-large;\"><strong><span style=\"color: rgb(255, 0, 0);\">厚度可以做到10mm以下</span></strong></span>。</p>', '1', '1240902890', '0', '1269589545', '-1');
...
-- ----------------------------
INSERT INTO `goods_img` VALUES ('1', '1', 'http://127.0.0.1/component/shopping/flow/images/2-2.jpg', '1');
INSERT INTO `goods_img` VALUES ('2', '2', 'http://127.0.0.1/component/shopping/flow/images/2-3.jpg', '0');
...
-- Records of payment
-- ----------------------------
INSERT INTO `payment` VALUES ('1', 'balance', '余额支付', '0', '使用帐户余额支付。只有会员才能使用，通过设置信用额度，可以透支。', '0', '1', '0', '1');
...
-- ----------------------------
INSERT INTO `user_address` VALUES ('3', '1', '陈泳霖', '15001209007@163.com', '1', '22', '297', '2453', '莱州', '100000', '15001209007', '15001209007', '小小', '12点之后');
INSERT INTO `user_address` VALUES ('4', '1', '陈泳霖1', '15001209007@163.com', '1', '6', '83', '764', '陈泳霖1', '100000', '15001209007', '15001209007', '小小1', '13点之后');
