...
function ui_confirm(msg,confirm,cancel,callback){
	bootbox.dialog({
	  message: "<h5>"+msg+"<h5>",
	  buttons: {
		main: {
                    label: confirm,
                    className: "btnsopt_main",
                    callback: function() {
                          callback();
                    }
...
$(document).ready(function() {
	...
	$("#menu dd a[node='" + current_node + "']").parent("dd").css("background","#F092C4");		
}); 