...
if ($verify_result) {//验证成功,包括sign验证与验证是否支付宝发来的消息
    ...
    if ($_POST['trade_status'] == 'TRADE_FINISHED') {
        ...
        if ($realuser_trade_no) {
            $info1 = 'alipaybank/notify_url.php,operator success,session == trade_no,ordernum:' . $user_trade_no
                    . ',alipayno:' . $trade_no;
            ...
            if ($ret['status'] == 0||$ret1['status'] == 1040) {  //get方式
...
//                    . '&type=' . $realuser_trade_type . '&jump=0');
            ...
            $info2 = 'alipaybank/notify_url.php,operator failed,session != trade_no,ordernum:' . $user_trade_no
                    . ',alipayno:' . $trade_no;
