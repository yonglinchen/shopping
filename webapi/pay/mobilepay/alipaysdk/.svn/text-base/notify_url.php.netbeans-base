...
//                    . '&type=' . $realuser_trade_type . '&jump=0');
        ...
        $info2 = 'alipayapp/notify_url.php,operator failed,session != trade_no,ordernum:' . $out_trade_no
                . ',alipayno:' . $trade_no;
    ...
    $info2 = 'alipayapp/notify_url.php,operator failed';
    ilog(iLOG_INFO, $info2, __LINE__);
    //验证失败
    echo "fail";
