...
require_once("AlipayRsa.class.php.php");
...
class AlipayNotify {
	...
	function getSignVeryfy($para_temp, $sign, $isSort) {
		...
		$prestr = \Library\pay\direct_pay\lib\AlipayCore::createLinkstring($para);
		
		$isSgin = false;
		switch (strtoupper(trim($this->alipay_config['sign_type']))) {
			case "MD5" :
				$isSgin = \Library\pay\direct_pay\lib\AlipayMd5::md5Verify($prestr, $sign, $this->alipay_config['key']);
				break;
			case "RSA" :
	...
	function getResponse($notify_id) {
		...
		$responseTxt = \Library\pay\direct_pay\lib\AlipayCore::getHttpResponseGET($veryfy_url, $this->alipay_config['cacert']);
