...
<body text=#000000 bgColor=#ffffff leftMargin=0 topMargin=4>
	<div id="main">
        ...
        <form name=alipayment action=alimobilepayapi.php method=post target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
                    <dt>卖家支付宝帐户：</dt>
                  <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDseller_email" value="allstarway@126.com"/>
                        <span></span>
                    </dd>
                    <dt>商户订单号：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDout_trade_no" value="1111112"/>
                        <span></span>
                    </dd>
                    <dt>订单名称：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDsubject" value="订单12"/>
                        <span></span>
                    </dd>
                    <dt>付款金额：</dt>
                    <dd>
