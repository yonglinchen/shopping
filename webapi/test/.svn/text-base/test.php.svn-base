...
<head>
    ...
    <script type="text/javascript" src="../libcode/js/js3party/jquery-1.7.2.min.js"></script>
    <script type="text/javascript" src="../libcode/js/jsapi/json2.js"></script>
    <script type="text/javascript" src="../libcode/js/jsapi/base.js"></script>
    
    <script type="text/javascript" src="wxDemo.js"></script>
...
<div class="wxapi_container">
    ...
    <div class="lbox_close wxapi_form">
      ...
      <button class="btn btn_primary" onClick="onMenuShareTimeline()">onMenuShareTimeline</button>
      <span class="desc">获取“分享给朋友”按钮点击状态及自定义分享内容接口</span>
      <button class="btn btn_primary" onClick="onMenuShareAppMessage()">onMenuShareAppMessage</button>
      <span class="desc">获取“分享到QQ”按钮点击状态及自定义分享内容接口</span>
      <button class="btn btn_primary" onClick="onMenuShareQQ()">onMenuShareQQ</button>
      <span class="desc">获取“分享到腾讯微博”按钮点击状态及自定义分享内容接口</span>
      <button class="btn btn_primary" onClick="onMenuShareWeibo()">onMenuShareWeibo</button>
      <span class="desc">获取“分享到QZone”按钮点击状态及自定义分享内容接口</span>
      <button class="btn btn_primary" onClick="onMenuShareQZone()">onMenuShareQZone</button>

      <h3 id="menu-image">图像接口</h3>
      <span class="desc">拍照或从手机相册中选图接口</span>
      <button class="btn btn_primary" onClick="chooseImage()">chooseImage</button>
      <span class="desc">预览图片接口</span>
      <button class="btn btn_primary" onClick="previewImage()">previewImage</button>
      <span class="desc">上传图片接口</span>
      <button class="btn btn_primary" onClick="uploadImage()">uploadImage</button>
      <span class="desc">下载图片接口</span>
      <button class="btn btn_primary" onClick="downloadImage()">downloadImage</button>

      <h3 id="menu-voice">音频接口</h3>
      <span class="desc">开始录音接口</span>
      <button class="btn btn_primary" onClick="startRecord()">startRecord</button>
      <span class="desc">停止录音接口</span>
      <button class="btn btn_primary" onClick="stopRecord()">stopRecord</button>
      <span class="desc">播放语音接口</span>
      <button class="btn btn_primary" onClick="playVoice()">playVoice</button>
      <span class="desc">暂停播放接口</span>
      <button class="btn btn_primary" onClick="pauseVoice()">pauseVoice</button>
      <span class="desc">停止播放接口</span>
      <button class="btn btn_primary" onClick="stopVoice()">stopVoice</button>
      <span class="desc">上传语音接口</span>
      <button class="btn btn_primary" onClick="uploadVoice()">uploadVoice</button>
      <span class="desc">下载语音接口</span>
      <button class="btn btn_primary" onClick="downloadVoice()">downloadVoice</button>

      <h3 id="menu-smart">智能接口</h3>
      <span class="desc">识别音频并返回识别结果接口</span>
      <button class="btn btn_primary" onClick="translateVoice()">translateVoice</button>

      <h3 id="menu-device">设备信息接口</h3>
      <span class="desc">获取网络状态接口</span>
      <button class="btn btn_primary" onClick="getNetworkType()">getNetworkType</button>

      <h3 id="menu-location">地理位置接口</h3>
      <span class="desc">使用微信内置地图查看位置接口</span>
      <button class="btn btn_primary" onClick="openLocation()">openLocation</button>
      <span class="desc">获取地理位置接口</span>
      <button class="btn btn_primary" onClick="getLocation()">getLocation</button>
      ...
      <button class="btn btn_primary" onClick="openProductSpecificView()">openProductSpecificView</button>

      <h3 id="menu-card">微信卡券接口</h3>
      <span class="desc">批量添加卡券接口</span>
      <button class="btn btn_primary" onClick="addCard()">addCard</button>
      <span class="desc">调起适用于门店的卡券列表并获取用户选择列表</span>
      <button class="btn btn_primary" onClick="chooseCard()">chooseCard</button>
      <span class="desc">查看微信卡包中的卡券接口</span>
      <button class="btn btn_primary" onClick="openCard()">openCard</button>

      <h3 id="menu-pay">微信支付接口</h3>
      <span class="desc">发起一个微信支付请求</span>
      <button class="btn btn_primary" onClick="chooseWXPay()">chooseWXPay</button>
    </div>
  </div>
</body>
</html>